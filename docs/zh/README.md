...
[![最新发行](https://img.shields.io/github/v/release/VorteX/VorteX?label=Release&logo=github)](https://github.com/VorteX/VorteX/releases/latest)
[![频道](https://img.shields.io/badge/Follow-Telegram-blue.svg?logo=telegram)](https://t.me/VorteX)
...
- VorteX 官方支持 GKI 2.0 的设备（内核版本 5.10 以上）。
...
请参考[文档](https://VorteX.github.io)

## 参与翻译

要将 VorteX 翻译成您的语言，或完善现有的翻译，请使用 [Crowdin](https://crowdin.com/project/VorteX).
