...
import com.vortex.vortex.ui.KsuService
import com.vortex.vortex.ui.util.HanziToPinyin
import com.vortex.zako.IKsuInterface
...
enum class AppCategory(val displayNameRes: Int, val persistKey: String) {
    ALL(com.vortex.vortex.R.string.category_all_apps, "ALL"),
    ROOT(com.vortex.vortex.R.string.category_root_apps, "ROOT"),
    CUSTOM(com.vortex.vortex.R.string.category_custom_apps, "CUSTOM"),
    DEFAULT(com.vortex.vortex.R.string.category_default_apps, "DEFAULT");
...
enum class SortType(val displayNameRes: Int, val persistKey: String) {
    NAME_ASC(com.vortex.vortex.R.string.sort_name_asc, "NAME_ASC"),
    NAME_DESC(com.vortex.vortex.R.string.sort_name_desc, "NAME_DESC"),
    INSTALL_TIME_NEW(com.vortex.vortex.R.string.sort_install_time_new, "INSTALL_TIME_NEW"),
    INSTALL_TIME_OLD(com.vortex.vortex.R.string.sort_install_time_old, "INSTALL_TIME_OLD"),
    SIZE_DESC(com.vortex.vortex.R.string.sort_size_desc, "SIZE_DESC"),
    SIZE_ASC(com.vortex.vortex.R.string.sort_size_asc, "SIZE_ASC"),
    USAGE_FREQ(com.vortex.vortex.R.string.sort_usage_freq, "USAGE_FREQ");
